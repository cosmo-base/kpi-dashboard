    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-background/80 border-b border-border/50">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Title */}
          <div>
            <h1 className="text-lg font-bold gradient-text">Cosmo Base Dashboard</h1>
            <p className="text-xs text-muted-foreground hidden sm:block">Community Growth Analytics</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-success/10 border border-success/20">
              ...
              <span className="text-xs font-medium text-success">Google Sheets Connected</span>
            </div>
